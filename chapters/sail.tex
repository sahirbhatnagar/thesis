...
Interactions may occur in numerous types and of varying complexities. In this paper, we consider one specific type of interaction models, where one (exposure) variable is involved in possibly non-linear interactions with a high-dimensional set of measures $\mb{X}$ leading to effects on a response variable, $Y$. We propose a multivariable penalization procedure for detecting non-linear interactions $\mb{X}$ and $E$. The proposed approach uses a simple change of variable to implement the heredity property. This allows us to combine both the $\ell_1$ and $\ell_2$ penalties to achieve sparse solutions while modeling both non-linear main effects and non-linear interaction effects.  
...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=0.37\linewidth]{figs/sail_intertruth_X3_paramIndex1_200sims.pdf}}
	\subfloat{\includegraphics[width=0.37\linewidth]{figs/sail_inter25_X3_paramIndex1_200sims.pdf}}\quad 
	\subfloat{\includegraphics[width=0.37\linewidth]{figs/sail_inter50_X3_paramIndex1_200sims.pdf}}
	\subfloat{\includegraphics[width=0.37\linewidth]{figs/sail_inter75_X3_paramIndex1_200sims.pdf}}
...
\begin{figure}[H]
	\centering
	\subfloat{\includegraphics[width=0.37\linewidth]{figs/sail_intertruth_X4_paramIndex1_200sims.pdf}}
	\subfloat{\includegraphics[width=0.37\linewidth]{figs/sail_inter25_X4_paramIndex1_200sims.pdf}}\quad 
	\subfloat{\includegraphics[width=0.37\linewidth]{figs/sail_inter50_X4_paramIndex1_200sims.pdf}}
	\subfloat{\includegraphics[width=0.37\linewidth]{figs/sail_inter75_X4_paramIndex1_200sims.pdf}}
