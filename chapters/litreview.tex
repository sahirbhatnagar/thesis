...
These methods however do not take advantage of any (possibly known) grouping structure in the data. For example, cortical thickness measurements from \ac{mri} scans are often grouped into cortical regions of the Automated Anatomical Labelling (AAL) atlas~\citep{tzourio2002automated}. 
